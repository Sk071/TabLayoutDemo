...
public class ftab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview2 = inflater.inflate(R.layout.fragment_ftab2,container,false);
       b2 = myview2.findViewById(R.id.b2);
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(),"This is fragment 2",Toast.LENGTH_SHORT).show();
            }
        });
        return myview2;
